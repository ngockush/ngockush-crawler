                ...
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <div class="row px-3 my-3">
                            <div class="w-100 col-form-label overflow-auto" id="movie-list" style="height: 20rem;background-color: #f7f7f7">
                    ...
                    <div class="col-12 mx-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-12 px-0">
                                <input class="group-checkall" data-target="{{ Str::slug($groupLabel) }}-group-checkbox" id="{{ Str::slug($groupLabel) }}-check-all" type="checkbox">
                                <label for="{{ Str::slug($groupLabel) }}-check-all">{{ $groupLabel }}</label>
                            </div>
                            @foreach ($options as $key => $option)
                            <div class="col-12 col-md-6 form-check checkbox">
                                <input class="form-check-input {{ Str::slug($groupLabel) }}-group-checkbox" id="{{ Str::slug($key) }}-{{ $loop->index }}" type="checkbox" name="fields[]" value="{{ $key }}" checked>
                ...
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <p>Crawl <span class="crawled-count">0</span>/<span class="total-crawl-count">0</span>
                            phim (Thành công: <span class="crawl-success-count">0</span>, thất bại: <span class="crawl-failed-count">0</span>).</p>
                        <div class="form-group row">
                            <div class="w-100 px-3 col-form-label overflow-auto mb-2 mx-3" id="crawl-list" style="height: 20rem;background-color: #f7f7f7">

                            </div>
                            <small><i id="wait_message"></i></small>
                            <div class="w-100 px-3 col-form-label overflow-auto mx-3" id="logs" style="height: 5rem;background-color: #f7f7f7">
